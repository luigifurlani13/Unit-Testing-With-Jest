...
test("One euro should be 127.9 yen", function(){
    ...
    // this is the comparison for the unit test
     expect(fromEuroToYen(3.5)).toBe(447.65000000000003); //1 euro are 127.9 yen, then 3.5 euros should be = (3.5 * 127.9)
})
...
test("One euro should be 0.8 pounds", function(){
    ...
    // if 1 euro are 0.8 pounds, then 3.5 euros should be (3.5 * 0.8
    const expected = 3.5 * 0.8; 
    
    // this is the comparison for the unit test
     expect(fromEuroToPound(3.5)).toBe(2.8000000000000003); //1 euro are 0.8 pounds, then 3.5 euros should be = (3.5 * 0.8)
})